...
// Obtener productos de chaquetas
...
$chaquetas = obtenerProductos($pdo, 'chaquetas');
...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('imagenes/fondochaquetas.jpg'); /* Aquí se agrega el fondo */
...
<body>
    ...
    <h1>CHAQUETAS</h1>
    <div class="productos">
        <?php foreach ($chaquetas as $producto): ?>
            <div class="producto">
